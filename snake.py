...
#keyboard bindings
window.listen()
window.onkeypress(go_up, "i")
window.onkeypress(go_down, "k")
window.onkeypress(go_left, "j")
window.onkeypress(go_right, "l")
...
while True:
    ...
    # Move segment 0 to where the head is located
    if len(segments) > 0:
        x = head.xcor()
        y = head.ycor()
        segments[0].goto(x,y)
